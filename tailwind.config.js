...
import { SCREENS } from './src/configs';
const plugin = require('tailwindcss/plugin');

export function screenToPx(screen) {
  return `${screen}px`;
}

export function screenUp(screen) {
  return { min: screenToPx(screen) };
}

export function screenDown(screen) {
  ...
  plugins: [
    ...
    plugin(({ addComponents }) => {
      addComponents({
        ...
        '.ds-text-body1-allcaps-regular-1': {
          '@apply font-notoSans': {},
          fontSize: '0.8125rem',
          lineHeight: '1.25rem',
          letterSpacing: '-0.025rem',
        ...
        '.ds-text-tiny-semibold-allcaps-1': {
          '@apply font-notoSans': {},
          fontSize: '0.75rem',
          lineHeight: '0.875rem',
          letterSpacing: '-0.1px',
        ...
        '.ds-text-tiny-semibold-allcaps-2': {
          '@apply font-notoSans': {},
          fontSize: '0.625rem',
          lineHeight: '0.75rem',
          letterSpacing: '-0.1px',
        ...
        '.ds-text-body2-allcaps-semibold': {
          '@apply font-notoSans': {},
          fontSize: '0.8125rem',
          lineHeight: '1.25rem',
          fontStyle: 'normal',
